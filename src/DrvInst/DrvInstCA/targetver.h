...
#ifndef WDK_NTDDI_VERSION            // Specifies that the minimum required platform is Windows XP.
...
#define _WIN32_MSI 410          // Change this to the appropriate value to target other versions of MSI.
#endif
